...
final class InteractiveTransition: UIPercentDrivenInteractiveTransition {
  ...
  @objc private func screenEdgePan(
    ...
    case .changed:
      let translation =
        recognizer.translation(in: recognizer.view)
      let relativeTranslationByX =
        translation.x / (recognizer.view?.bounds.width ?? 1)
